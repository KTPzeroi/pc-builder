...
async def run_test():
    ...
    try:
        ...
        # -> Clear and fill the username/email and password fields with admin / 1234, then submit the login form.
        frame = context.pages[-1]
        # Input text
        ...
        # -> Click the notifications (bell) button in the navbar to open the notifications dropdown and verify that notifications are shown or an empty state is displayed.
        frame = context.pages[-1]
        # Click element
