...
async def run_test():
    ...
    try:
        ...
        # -> Click the sign in (LOGIN) action in the navigation bar to open the login form.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div[2]/nav/header/ul[2]/li/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        
        # -> Fill the 'Username or Email' input with 'admin', fill the 'Password' input with '1234', then click the 'Log In' button to submit.
        frame = context.pages[-1]
        # Input text
